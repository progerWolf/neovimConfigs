...
:luafile ~/.config/nvim/luapluginsconfig/blankline.lua
:luafile ~/.config/nvim/luapluginsconfig/luasnip.lua
:luafile ~/.config/nvim/luapluginsconfig/autoSave.lua
...
nnoremap <leader>gs <cmd>lua require('telescope.builtin').git_status(require('telescope.themes').get_dropdown({}))<cr>
nnoremap <C-A> :NERDTreeToggle<CR>
nnoremap <C-w> :StripWhitespace<CR>
